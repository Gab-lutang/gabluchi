...
public partial class App : Application
{
	...
	public App()
	{
		...
		services.AddSingleton<CreamApiUnlocker>();
		services.AddSingleton<UplayR1Unlocker>();
	...
	protected override async void OnStartup(StartupEventArgs e)
	{
		...
		dlcManager.Register(_host.Services.GetRequiredService<UplayR1Unlocker>());
		dlcManager.Register(_host.Services.GetRequiredService<UplayR2Unlocker>());
